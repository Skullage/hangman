...
<template>
  <div class="dark:bg-secondaryDark p-4 lg:p-20 rounded-2xl relative">
    <div class="flex justify-between items-start mb-12 flex-wrap gap-4">
      <button
        class="basis-8 flex-0 border p-2 rounded-2xl dark:hover:bg-white dark:hover:text-black duration-300"
        @click="leave"
      >
    ...
    <div
      class="flex md:justify-between flex-wrap justify-center mb-10 md:mb-20 items-start"
    >
    ...
    <div class="word flex justify-center flex-wrap gap-3">
      <base-button
        ...
        :key="index"
        class="text-2xl dark:bg-fourthDark dark:text-fifthDark basis-14 flex-initial dark:hover:border-thirdDark hover:border-4 border-4 border-transparent"
